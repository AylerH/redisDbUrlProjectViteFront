...
import { matchCompanyById } from '../api/redisApi';

const FuzzyMatchById: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await matchCompanyById(dbName, query, minSimilarity);
      setResult(response);
    } catch (err) {
